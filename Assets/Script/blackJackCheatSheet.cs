...
public class blackJackCheatSheet : MonoBehaviour {
    ...
    // this is a very ugly and bad way of doing this. I did this because in my "timed" game scene, I had to pass in randomCardsTimed instead of randomCards
    //TODO: I probably don't need to do this since the cards will be chosen in advance.
    public int blackJackCheatSheetMethodTutorial(tutorial.CardObject firstPlayerCard, tutorial.CardObject secondPlayerCard, tutorial.CardObject firstDealerCard)
    {
